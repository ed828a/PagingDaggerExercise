...
import com.dew.edward.pagingrxjava.BuildConfig
...
class MovieDataSource(private val serviceApi: ServiceApi) : PageKeyedDataSource<Int, MovieResponse.Movie>() {
    ...
    companion object {
        const val MOVIE_API_KEY = BuildConfig.MOVIE_API_KEY   // Replace with your API key. Get Api key from themoviedb.org
    }
